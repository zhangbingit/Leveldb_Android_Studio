...
/**
 * 使用方法：不同的使用者
 * private MyLogger logger = MyLogger.bbLog();
 * bbLog.i("This is  what you want to say");
 * <p/>
 * 现实为TAG log用户，线程名，文件名，行号，方法名，log内容
 * Created by bb on 15/5/20.
 */
public class MyLogger implements Serializable {
     ...
     * @return
     */
    public static MyLogger bblog() {
        if (bblog == null) {
            bblog = new MyLogger(BB);
        }
        return bblog;
    }
